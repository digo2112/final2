...
namespace Final2.Controllers
{
    ...
    {
        private readonly Final2Context _context;

        public Departments1Controller(Final2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Department != null ? 
                          ...
                          Problem("Entity set 'Final2Context.Department'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Final2Context.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
